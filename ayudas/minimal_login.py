...
def signin():
    ...
    global img1
    img1 = ImageTk.PhotoImage(Image.open("f:\\03_Codigos_Prueba\\02 ventanas pruebas\\03 login\\signin.png"))
    Label(signin_win,image=img1,border=0,bg='white').place(x=50,y=50)

    l2=Label(signin_win,text="Inicia sesión",fg='#00ADB5',bg='white')
    ...
    e1 =Entry(f1,width=25,fg='#00ADB5',border=0,bg='white')
    ...
    Frame(f1,width=295,height=2,bg='#222831').place(x=25,y=87)
    ...
    e2 =Entry(f1,width=21,fg='#00ADB5',border=0,bg='white')
    ...
    Frame(f1,width=295,height=2,bg='#222831').place(x=25,y=157)

    #-mech------------------------------------------------
    def signin_cmd():
        
        file=open('F:\\03_Codigos_Prueba\\02 ventanas pruebas\\03 login\\datasheet.txt','r')
        d=file.read()
    ...
    #------------------------------------------------------
    Button(f1,width=39,pady=7,text='Inicia sesión',bg='#393E46',fg='#00ADB5',border=0,command=signin_cmd).place(x=35,y=204)
    l1=Label(f1,text="No tienes cuenta?",fg="#222831",bg='white')
    l1.config(font=('Microsoft YaHei UI Light',9, ))
    l1.place(x=95,y=250)

    b2=Button(f1,width=8,text='Registrate',border=0,bg='white',fg='#00ADB5',command=signup)
...
def signup():
    ...
    global img2
    img2 = ImageTk.PhotoImage(Image.open("F:\\03_Codigos_Prueba\\02 ventanas pruebas\\03 login\\signup.png"))
    ...
    def signup_cmd():
        ...
        if value==value2:
            file=open('F:\\03_Codigos_Prueba\\02 ventanas pruebas\\modern login\\datasheet.txt','r+')
            d=file.read()
            r=ast.literal_eval(d)
            print(r)
            ...
            file.close()
            print(r)
            file=open('F:\\03_Codigos_Prueba\\02 ventanas pruebas\\modern login\\datasheet.txt','w')
            w=file.write(str(r))
